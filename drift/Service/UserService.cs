...
namespace drift.Service
{
    public class UserService
    {
        ...
        public static UserDto MapUser(IdentityUser user)
        {
            return new UserDto()
            {
                Email = user.Email,
        ...
        {
            if (_context.CompetitionApplications.Count(x =>
                x.ParticipantNumber == dto.ParticipantNumber && x.CompetitionId == dto.CompetitionId) > 0)
                return false;
            return true;
        }
